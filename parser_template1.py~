...
infile='GDS3793_full.soft' #This is the name of the input file
fh=open(infile)

#step 2. read the first line and then read more lines while the line doesn't match a specific pattern
line= fh.readline()
while line[:20] !='!dataset_table_begin': #it will read the start of the line up to the 20th character until it reaches the word dataset_table_begin
    line=fh.readline()
